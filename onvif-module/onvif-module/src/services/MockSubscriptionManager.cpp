        ...
        "<wstop:TopicSet>"
          "<tns1:VideoSource>"
            ...
            "<GlobalSceneChange wstop:topic=\"true\">"
              ...
              "</tt:MessageDescription>"
            "</GlobalSceneChange>"
            // Chuẩn ONVIF (Imaging Spec): tampering event là 3 CẤP — leaf là service
            // qualifier (ImagingService), không phải leaf trực tiếp dưới VideoSource.
            // Topic thật: tns1:VideoSource/ImageTooBlurry/ImagingService. Khai 2 cấp
            // (như MotionAlarm) khiến DTT không nhận là tampering event.
            "<ImageTooBlurry>"
          ...
          "</tns1:Media>"
          // Profile G mandatory: RecordingConfig/JobState (§Recording control)
          // + RecordingHistory/Recording/State + /Track/State (§Recording search).
          // Prefix chỉ node gốc (tns1:RecordingConfig/tns1:RecordingHistory), leaf
          // KHÔNG prefix — cùng quy ước VideoSource/Media ở trên.
          ...
          "<tns1:RecordingHistory>"
            "<Recording>"
              "<State wstop:topic=\"true\">"
                "<tt:MessageDescription IsProperty=\"true\">"
                  "<tt:Source><tt:SimpleItemDescription Name=\"RecordingToken\" Type=\"tt:ReferenceToken\"/></tt:Source>"
                  "<tt:Data><tt:SimpleItemDescription Name=\"IsRecording\" Type=\"xs:boolean\"/></tt:Data>"
                "</tt:MessageDescription>"
              "</State>"
            "</Recording>"
            "<Track>"
              "<State wstop:topic=\"true\">"
                "<tt:MessageDescription IsProperty=\"true\">"
                  ...
                  "</tt:Source>"
                  "<tt:Data><tt:SimpleItemDescription Name=\"IsDataPresent\" Type=\"xs:boolean\"/></tt:Data>"
                "</tt:MessageDescription>"
              "</State>"
            "</Track>"
          "</tns1:RecordingHistory>"

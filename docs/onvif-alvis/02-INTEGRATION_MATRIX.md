...
| ONVIF users/RBAC | S/T/M/G | MGMT/Security | Identity API | MOCK | Mock user chưa phải persistent shared identity |
...
| MGMT internal client config/auth | ONVIF + MGMT | OPEN |
